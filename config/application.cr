...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Crystal Api web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 479DoRb8NQPZdS4Eq0WMbhg4FQ7kH2nV59JxQOI2D5w
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("crystal-api.log", "w"))
  #
  #
end
